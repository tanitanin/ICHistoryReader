...
using ICHistoryReader.Activation;
using ICHistoryReader.BackgroundTasks;
using ICHistoryReader.Core.Helpers;

using Windows.ApplicationModel.Activation;
using Windows.ApplicationModel.Background;

namespace ICHistoryReader.Services
{
    internal class BackgroundTaskService : ActivationHandler<BackgroundActivatedEventArgs>
    {
        ...
        private static IEnumerable<BackgroundTask> CreateInstances()
        {
            ...
            backgroundTasks.Add(new BackgroundReader());
